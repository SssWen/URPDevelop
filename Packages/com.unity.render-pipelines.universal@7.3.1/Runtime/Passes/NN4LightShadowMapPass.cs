...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    /// </summary>
//    public class NN4LightShadowMapPass : ScriptableRenderPass // Copy From MainLightShadowcasterPass
//    {
...
//
//        Matrix4x4 m_NN4LightShadowMatrices;// 不需要cascade
//        
//
//        const string m_ProfilerTag = "Render NN Shadowmap";
//        ProfilingSampler m_ProfilingSampler = new ProfilingSampler(m_ProfilerTag);
//
//        // Shader skinShadowMaskShader;
//        // Shader shadowCasterShader;
//        // public RenderTexture shadowMap;
//        // private Camera _shadowMaskBodyCam;
//        // private Camera _shadowCamera;
//        // NN4PerObjectShadowMapping.cs
//
//        public NN4LightShadowMapPass(RenderPassEvent evt)
//        {
//            renderPassEvent = evt;
//
//            m_NN4LightShadowMatrices = Matrix4x4.identity;            
//
...
//        {
//            RenderNN4LightShadowmap(ref context, ref renderingData.cullResults, ref renderingData.lightData, ref renderingData.shadowData);
//        }
//
//        /// <inheritdoc/>
...
//        }
//
//        void RenderNN4LightShadowmap(ref ScriptableRenderContext context, ref CullingResults cullResults, ref LightData lightData, ref ShadowData shadowData)
//        {
...
//                m_NN4LightShadowMatrices[i] = m_CascadeSlices[i].shadowTransform;
//
...
//                m_NN4LightShadowMatrices[i] = noOpShadowMatrix;
//
...
//            cmd.SetGlobalMatrixArray(MainLightShadowConstantBuffer._WorldToShadow, m_NN4LightShadowMatrices);
