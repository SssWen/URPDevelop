// Upgrade NOTE: upgraded instancing buffer 'CustomEyeShadersEyeShader_ASE' to new syntax.

// Made with Amplify Shader Editor
// Available at the Unity Asset Store - http://u3d.as/y3X 
Shader "Custom/EyeShaders/EyeShader_ASE"
{
	Properties
	{
	...
	SubShader
	{
		...
		uniform float _EyeReflectFactor;
		uniform samplerCUBE _EyeReflectCubeMap;
		uniform float3 _XYZ_Axis;
		uniform float _RotateXYZ;
...
#define _MinimumGlow_arr CustomEyeShadersEyeShader_ASE
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 temp_cast_4 = (temp_output_899_0).xx;
			float2 temp_cast_6 = (( ( 1.0 - temp_output_899_0 ) / 2.0 )).xx;
			float2 uv_TexCoord264 = i.uv_texcoord * temp_cast_4 + temp_cast_6;
			...
			float3 temp_cast_8 = (( pow( ( temp_output_861_0 + temp_output_861_0 + temp_output_861_0 + temp_output_861_0 ) , ( 25.0 * _EyeShadingPower ) ) * fresnelNode866 )).xxx;
			...
			float3 eyeShading672 = ( ( temp_cast_8 * temp_output_2_0_g43 ) + appendResult7_g43 );
			...
			float clampResult545 = clamp( ( _PupilSize + ( ( ( ( ( break690.x + break690.y + break690.z ) / 3.0 ) * ( dotResult4_g24 - (-1.0 + (ase_lightColor.a - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) ) ) * IrisPupil_MASK585 ) * ( _PupilAutoDilateFactor + ( _PupilAutoDilateFactor * FullEyeFactor878 ) ) ) ) , 0.0 , 99.0 );
			...
			float2 temp_cast_16 = (eyeSizing616).xx;
			float2 uv_TexCoord190 = i.uv_texcoord * temp_cast_16 + ( ( ParallaxPush_Vec2580 * float2( 0.15,0.15 ) ) + ( ( 1.0 - eyeSizing616 ) / 2.0 ) );
			float4 BaseIrisColors809 = ( ( ( ( tex2D( _IrisExtraDetail, uv_TexCoord190 ) * _IrisExtraColorAmountA ) * _IrisExtraColorAmountA.a ) * IrisPupil_MASK585 ) + ( IrisPupil_MASK585 * _IrisBaseColor ) );
			...
			float3 temp_cast_19 = (pow( ( clampResult7_g40 * clampResult8_g40 ) , _EyeShadingPower )).xxx;
			...
			float4 lerpResult568 = lerp( ( temp_output_326_0 * float4( ( clampResult478 * ( ( temp_cast_19 * temp_output_2_0_g41 ) + appendResult7_g41 ) ) , 0.0 ) ) , float4( 0,0,0,0 ) , eyeLimbalRingPower612);
			...
			float3 normal918 = reflect( -ase_worldViewDir , (WorldNormalVector( i , lerpResult569 )) );
			...
			o.Emission = ( ( ( ( caustEmissission827 * causticInDark824 ) + ( ase_lightColor * PreEmissive804 ) ) * PupilMaskArea625 ) + PupilGlow833 + ( _EyeReflectFactor * texCUBE( _EyeReflectCubeMap, localRotationMatrix923 ) * IrisPupil_MASK585 ) ).rgb;
...
/*ASEBEGIN
Version=16800
1920;0;1920;1019;3597.853;480.3754;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;631;-5732.188,-1686.254;Float;False;1277.707;559.7808;PupilControl;12;587;543;555;91;542;537;686;694;873;874;875;878;Pupil Control;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;873;-5672.611,-1205.574;Float;False;Property;_FullEyeFactor;[眼球整体放大]FullEyeFactor;22;0;Create;False;0;0;False;0;0;0.76;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;615;-3521.69,-824.9874;Float;False;2148.08;465.2037;Sizing;15;616;323;578;247;604;264;265;266;267;893;895;899;896;900;902;Sizing;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;267;-3598.22,-457.6284;Float;False;Property;_EyeSize;[虹膜放大]EyeSize;12;0;Create;False;0;0;False;0;1;0.37;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;892;-3561.603,-676.151;Float;False;878;FullEyeFactor;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;893;-3554.45,-564.8354;Float;False;Constant;_Int0;Int 0;36;0;Create;True;0;0;False;0;2;0;0;1;INT;0
Node;AmplifyShaderEditor.OneMinusNode;896;-3343.309,-638.2692;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;895;-3331.353,-503.4353;Float;False;2;0;INT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;899;-3138.161,-604.1864;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;266;-3067.864,-465.7361;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;265;-2848.496,-438.8314;Float;False;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;264;-2664.554,-532.8677;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;6,6;False;1;FLOAT2;-2.5,-2.5;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;605;-3456.858,-93.25156;Float;False;604;eyeSizeUVs;1;0;OBJECT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;707;-2990.846,75.49301;Float;False;Property;_LimbalEdge_Adjustment;LimbalEdge_Adjustment;9;0;Create;True;0;0;False;0;0;0.457;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.LightColorNode;685;-6625.374,-1893.515;Float;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleSubtractOpNode;705;-2647.987,-118.2514;Float;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;706;-2479.763,-49.1507;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;543;-5647.761,-1434.477;Float;False;Property;_PupilAutoDilateFactor;[瞳孔大小]PupilAutoDilateFactor;32;0;Create;False;0;0;False;0;0;10.9;0;50;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;587;-5681.011,-1524.082;Float;False;585;IrisPupil_MASK;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;875;-5138.271,-1294.653;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;874;-5131.141,-1441.056;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;91;-5662.821,-1334.853;Half;False;Property;_PupilSize;[瞳孔大小]PupilSize;33;0;Create;False;0;0;False;0;70;32.7;0.001;90;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;164;-4325.575,-1592.661;Float;False;3085.553;637.4598;Pupil;24;625;122;286;155;285;146;600;214;213;147;149;148;152;582;154;157;153;156;577;327;151;328;545;872;Pupil Control - UV;1,1,1,1;0;0
Node;AmplifyShaderEditor.SimpleAddOpNode;537;-4816.12,-1435.986;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;545;-4325.713,-1507.758;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;99;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;872;-4143.746,-1562.076;Float;False;2;0;FLOAT;100;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;151;-4034.638,-1517.003;Float;False;2;0;FLOAT;100;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;328;-4286.182,-1348.615;Float;False;Constant;_IrisPupilBond;Iris-Pupil-Bond;23;0;Create;True;0;0;False;0;0.017;0.017;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;247;-3194.484,-765.4198;Float;False;Property;_BIrisSize;[虹膜纹理放大]IrisSize;13;0;Create;False;0;0;False;0;1;8.33;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;327;-3890.809,-1392.011;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0.01;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode;901;-3007.817,-878.1002;Float;False;Constant;_Int1;Int 1;36;0;Create;True;0;0;False;0;10;0;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;257;-5668.911,-1030.676;Float;False;Property;_PupilParallaxHeight;PupilParallaxHeight;36;0;Create;True;0;0;False;0;2.5;0;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;902;-2774.375,-826.6811;Float;False;2;0;INT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;416;-5673.329,-785.6605;Float;True;Property;_ParallaxMask;ParallaxMask;34;1;[NoScaleOffset];Create;True;0;0;False;1;Header(Parallax Control);None;451268057d3fa344e8695ec36ec39129;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;419;-4996.699,-631.905;Float;False;Property;_PushParallaxMask;PushParallaxMask;35;0;Create;True;0;0;False;0;1;0;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;900;-2549.668,-756.851;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;168;-3488,576;Float;False;1464.509;1000.859;Inputs;18;595;594;261;182;593;133;589;284;581;612;249;617;250;283;190;618;619;622;Color Inputs;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;617;-3360,1344;Float;False;616;eyeSizing;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;581;-3120,1248;Float;False;580;ParallaxPush_Vec2;1;0;OBJECT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;575;-5667.397,-373.1516;Float;False;574;PupilParallaxHeight;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;249;-3072,1344;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;284;-2800,1248;Float;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0.15,0.15;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;250;-2784,1344;Float;False;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;618;-2624,1200;Float;False;616;eyeSizing;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;156;-4261.873,-1156.933;Float;False;Property;_PupilHeight1Width1;[瞳孔形状]Pupil;30;0;Create;False;0;0;False;0;1;10;0.01;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;283;-2544,1312;Float;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;190;-2304,1248;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;6,6;False;1;FLOAT2;-2.5,-2.5;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;157;-3814.29,-1162.465;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;153;-3603.956,-1473.407;Float;False;2;0;FLOAT;2;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;170;-1908.036,772.9764;Float;False;Property;_EyeVeinColorAmountA;[血管颜色]EyeVeinColor-Amount(A);7;0;Create;False;0;0;False;0;0.375,0,0,0;0.764151,0.4645935,0.37847,0.497;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleDivideOpNode;148;-3498.602,-1321.328;Float;False;2;0;FLOAT;2;False;1;FLOAT;2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;187;-1915.38,1314.087;Float;False;Property;_IrisExtraColorAmountA;[虹膜遮罩颜色]IrisExtraColor-Amount(A);6;0;Create;False;0;0;False;0;0.08088237,0.07573904,0.04698314,0.591;0.3255562,0.4716981,0.3181733,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;154;-3458.687,-1175.436;Float;False;2;0;FLOAT;2;False;1;FLOAT;4;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;582;-3466.066,-1375.865;Float;False;580;ParallaxPush_Vec2;1;0;OBJECT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.DynamicAppendNode;152;-3412.445,-1491.719;Float;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;593;-3429,1039;Float;False;590;LimbalRing_MASK;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;147;-3169.418,-1506.83;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;213;-3088.348,-1180.257;Float;False;Property;_PupilSharpness;[瞳孔模糊]PupilSharpness;31;0;Create;False;0;0;False;0;5;0.1;0.1;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;182;-3439,831;Float;False;Property;_RingColorAmount;[虹膜边缘]_RingColorAmount;8;0;Create;False;0;0;False;0;0,0,0,0;0.990566,0.3504351,0.3504351,0.353;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;589;-2880,688;Float;False;585;IrisPupil_MASK;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;149;-3222.629,-1276.792;Float;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;261;-3008,960;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;600;-2587.442,-1158.279;Float;False;585;IrisPupil_MASK;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;595;-2464,704;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;214;-2769.639,-1182.017;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;7;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;126;-706.0718,1582.184;Float;False;Property;_IrisBaseColor;[虹膜颜色]IrisBaseColor;5;0;Create;False;0;0;False;0;0.4999702,0.5441177,0.4641004,1;0.1320737,0.1160314,0.0679053,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DistanceOpNode;146;-2860.775,-1437.964;Float;True;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;133;-3440,640;Float;False;Property;_EyeBallColorGlossA;[眼白颜色]EyeBallColor-Gloss(A);4;0;Create;False;0;0;False;2;Header(Color Customization);Space(6);1,1,1,0.853;0.8962264,0.8962264,0.8962264,0.8784314;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;594;-2240,624;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.OneMinusNode;285;-2172.143,-1151.367;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;155;-2541.058,-1444.359;Float;True;2;0;FLOAT;0;False;1;FLOAT;12;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;286;-1955.995,-1245.143;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;50;-764.0728,2238.058;Float;False;Property;_CausticPower;CausticPower;27;0;Create;True;0;0;False;0;17;0.5;0.5;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;122;-1745.151,-1234.716;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;370;-650.2144,2062.136;Float;True;Property;_CausticMask;CausticMask;26;1;[NoScaleOffset];Create;True;0;0;False;1;Header(Caustic FX);None;589388b2c0f29904a9ae50f91d3d36e5;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;626;331.6477,1245.792;Float;False;625;PupilMaskArea;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;489;594.1643,1489.961;Float;False;InstancedProperty;_MinimumGlow;MinimumGlow;40;0;Create;True;0;0;False;0;0.2;0.229;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;669;-43.51121,-496.9287;Float;False;MicroScatterScale_vec2;41;;42;27afac86e902b3f4680f2698fbeab237;0;0;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;750;-326.8658,2509.578;Float;False;Property;_CausticFX_inDarkness;CausticFX_inDarkness;28;0;Create;True;0;0;False;0;17;0;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;637;1687.879,1711.533;Float;False;LocalShadowing;37;;40;cbbcb7bdaf1755b499ae374337e1f753;0;0;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;467;-1570.481,3115.249;Float;False;Property;_EyeShadingPower;EyeShadingPower;39;0;Create;True;0;0;False;0;0.5;0.01;0.01;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;167;-574.3536,48;Float;False;2142.244;468.7774;Normal Maps;9;331;602;139;333;607;141;138;140;606;Normal Maps;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;499;353.9738,-223.3932;Float;False;Property;_Eyeball_microScatter;Eyeball_microScatter;43;0;Create;True;0;0;False;0;0;5;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;607;641.6464,80;Float;False;604;eyeSizeUVs;1;0;OBJECT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;606;-126.3536,208;Float;False;604;eyeSizeUVs;1;0;OBJECT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;333;577.6464,144;Float;False;Property;_ScleraBumpScale;ScleraBumpScale;11;0;Create;True;0;0;False;0;0;0.273;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;140;225.6464,64;Float;False;Constant;_Vector0;Vector 0;10;0;Create;True;0;0;False;0;0,0,1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SamplerNode;331;945.6464,80;Float;True;Property;_Sclera_Normal;Sclera_Normal;2;1;[NoScaleOffset];Create;True;0;0;False;0;None;97ac39d433ae05047abf79173f71d460;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;141;227.6464,474;Float;False;Property;_LensPush;[高光点推进]LensPush;15;0;Create;False;0;0;False;0;0.64;0.788;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;139;737.6464,320;Float;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.BlendNormalsNode;332;1661.057,67.2785;Float;False;0;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.CommentaryNode;910;2666.621,-613.9626;Float;False;1175.634;580.9745;Eye Reflect;13;909;911;915;916;917;918;919;914;921;922;923;925;924;Reflect CubeMap;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;671;2251.199,112.6175;Float;False;809.7659;371.8926;Blend normals;2;640;569;Blends Normal maps;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;602;1137.646,384;Float;False;585;IrisPupil_MASK;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;569;2474.863,224.9719;Float;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ColorNode;647;2707.268,1444.284;Float;False;Property;_PupilColorEmissivenessA;[瞳孔颜色]PupilColor-Emissiveness(A);29;0;Create;False;0;0;False;2;Header(Pupil Control);Space(6);0,0,0,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.NegateNode;917;2883.827,-326.5647;Float;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;783;3180.29,794.4534;Float;True;784;SubSurfaceArea;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.WorldNormalVector;914;2686.927,-197.9115;Float;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;665;3041.243,1719.121;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-753.7518,947.6635;Float;False;Property;_LensGloss;[高光点放大]LensGloss;14;0;Create;False;0;0;False;0;0.98;0.133;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;919;2814.176,-460.8659;Float;False;Property;_Rotate_Y;[旋转高光]Rotate_Y;19;0;Create;False;0;0;False;0;0;219;-360;360;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;723;-2128.732,-215.2754;Float;False;Property;_LimbalRingMetalness;LimbalRingMetalness;23;0;Create;True;0;0;False;1;Header(Metalness);0;0.047;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;722;-2105.917,-106.2091;Float;False;Property;_EyeBallMetalness;EyeBallMetalness;25;0;Create;True;0;0;False;0;0;0.329;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;776;217.8759,859.0576;Float;False;Property;_LimbalRingGloss;LimbalRingGloss;10;0;Create;True;0;0;False;0;0;0.408;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;724;-2111.768,155.1683;Float;False;Property;_IrisPupilMetalness;IrisPupilMetalness;24;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ReflectOpNode;915;3019.57,-322.0942;Float;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;924;3365.758,-170.8354;Float;False;Property;_RotateXYZ;[旋转高光]RotateXYZ;20;0;Create;False;0;0;False;0;0;-49;-360;360;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;925;3471.758,-426.8354;Float;False;Property;_XYZ_Axis;XYZ_Axis;21;0;Create;True;0;0;False;0;0,0,0;1,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;789;3885.831,1021.573;Float;False;Property;_SubSurfaceFromDirectionalLight;SubSurfaceFromDirectionalLight;44;0;Create;True;0;0;False;0;0.5;0.785;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;911;3372.531,-611.3324;Float;False;Property;_EyeReflectFactor;[高光系数]EyeReflectFactor;18;0;Create;False;0;0;False;0;0;2;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;904;3860.476,-436.045;Float;True;Property;_EyeReflectCubeMap;[反射高光]EyeReflectCubeMap;16;0;Create;False;0;0;False;0;None;7528b39067a658d4b9734addc3f967e6;True;0;False;white;LockedToCube;False;Object;-1;Auto;Cube;6;0;SAMPLER2D;;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;909;3161.372,-245.8281;Float;True;585;IrisPupil_MASK;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;905;4232.023,-419.2168;Float;False;3;3;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;922;3427.687,-518.1463;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;846;5004.753,1708.175;Float;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;641;5391.926,1527.195;Float;False;640;NORMAL_OUTPUT;1;0;OBJECT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;921;3129.687,-538.1463;Float;False;Property;_ReflectScale;[高光放大]ReflectScale;17;0;Create;False;0;0;False;0;0;4;0;4;0;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;6181.279,1606.051;Float;False;True;2;Float;ASEMaterialInspector;0;0;Standard;Custom/EyeShaders/EyeShader_ASE;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;ForwardOnly;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=301B659E033DCACC2F5D03FB8741BB4AC61F46F5